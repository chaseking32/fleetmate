    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-500">Auto Liability</label>
              <p className="mt-1 text-sm text-gray-900">$1,000,000</p>
              <div className="flex items-center mt-1">
                <div className="h-2 w-2 rounded-full bg-green-500 mr-2"></div>
                <span className="text-xs text-green-600">Active until Dec 31, 2024</span>
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-500">Cargo Insurance</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-500">General Liability</label>
              <p className="mt-1 text-sm text-gray-900">$1,000,000</p>
              <div className="flex items-center mt-1">
                <div className="h-2 w-2 rounded-full bg-green-500 mr-2"></div>
                <span className="text-xs text-green-600">Active until Dec 31, 2024</span>
      ...
      <div>
        <h3 className="text-lg font-medium text-gray-900 mb-4">Equipment Compliance</h3>
        <div className="space-y-2">
          <div className="flex items-center">
            <svg className="h-5 w-5 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
            </svg>
            <span className="ml-2 text-sm text-gray-900">Air-Ride Suspension</span>
          </div>
          <div className="flex items-center">
            <svg className="h-5 w-5 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
      ...
      <div>
        ...
        <div className="bg-yellow-50 p-4 rounded-md">
          <p className="text-sm text-yellow-700">
            Driver must have minimum 2 years experience. Temperature monitoring required.
          </p>
        </div>
      </div>
